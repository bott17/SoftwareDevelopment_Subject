 ...
 * @see SystemUiHider
 */
public class ExternalGameActivity extends Activity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_external_game);
        setFullScreen();
    ...
    protected void initComponents() {
        ...
        marco = (WebView) findViewById(R.id.webView);
        marco.setWebViewClient(new MyBrowserClient());
